...
struct FrontWallM : public Shape
{
	FrontWallM()
	{
		...
		shape_vertices = {
			...
			0.4f, 1.0f, 2.0f,		// 3.
			// Right.
			0.6f, 0.7f, 2.0f,		// 4. 12	Z was 0
			0.6f, 0.7f, 1.95f,		// 0. 13
			0.6f, 1.0f, 1.95f,		// 3. 14
			0.6f, 1.0f, 2.0f,
			// Back.
			0.6f, 0.7f, 1.95f,		// 5. 8
			0.4f, 0.7f, 1.95f,		// 4. 9
			0.4f, 1.0f, 1.95f,		// 7. 10
			0.6f, 1.0f, 1.95f,		// 6. 11
			// Left.
			0.4f, 0.7f, 1.95f,		// 1. 4		
			0.4f, 0.7f, 2.0f,		// 5. 5		Z was 0
			0.4f, 1.0f, 2.0f,		// 6. 6		Z was 0
			0.4f, 1.0f, 1.95f,		// 2. 7		
			// Top.
			0.4f, 1.0f, 1.95f,		// 7. 16  Z was 0
			0.4f, 1.0f, 2.0f,		// 3. 17  
			0.6f, 1.0f, 2.0f,		// 2. 18
			0.6f, 1.0f, 1.95f,		// 6. 19	Z was 0
			// Bottom.
			0.4f, 0.7f, 2.0f,		// 4. 20	Z was 0
			0.4f, 0.7f, 1.95f,		// 5. 21	Z was 0
			0.6f, 0.7f, 1.95f,		// 1. 22
			0.6f, 0.7f, 2.0f		// 0. 23
		};
		shape_uvs = {
			// Front.
